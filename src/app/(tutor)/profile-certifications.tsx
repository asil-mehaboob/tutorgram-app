        ...
        renderItem={({ item }) => (
          <View style={[styles.card, { backgroundColor: theme.surface, borderColor: theme.border }]}>
            ...
            <View style={styles.cardActions}>
              ...
              <Pressable onPress={() => Alert.alert('Delete', `Remove "${item.name}"?`, [{ text: 'Cancel', style: 'cancel' }, { text: 'Delete', style: 'destructive', onPress: () => deleteM.mutate(item.id) }])} style={[styles.iconBtn, { backgroundColor: '#FFEBEE' }]}><Trash size={15} color={theme.error} weight="bold" /></Pressable>
            </View>
          </View>
        )}
      />
